class RegexConstants {
  ...
  static const String validPhoneFirstNotZeroRegex =
      r'^[1-9][0-9]*$'; //Phone number

  static const String hasSpaceCharacter =
      r' '; //Phone number should be in range 3 to 15 chars

  static const String validPasswordlRegex =r'^(?=.*?[a-zA-Z])(?=.*?[0-9]).{6,128}$';
  static const String validPasswordlRegexOld =r'^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[!@#\$&*~]).{8,128}$';
  static const String validPasswordSameWordRegex =r'([A-Za-z0-9?=.*?[!@#\$&*~])\1{2,}';
