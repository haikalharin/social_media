...
class _$ArticleModelCopyWithImpl<$Res> implements $ArticleModelCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? shortScreenshots = freezed,
  ...
  $EsrbRatingCopyWith<$Res>? get esrbRating {
    ...
    return $EsrbRatingCopyWith<$Res>(_value.esrbRating!, (value) {
      return _then(_value.copyWith(esrbRating: value));
    });
  }
}
...
class _$_ArticleModel implements _ArticleModel {
  ...
  @override
  String toString() {
    return 'ArticleModel(slug: $slug, name: $name, playtime: $playtime, platforms: $platforms, stores: $stores, released: $released, tba: $tba, backgroundImage: $backgroundImage, rating: $rating, ratingTop: $ratingTop, ratings: $ratings, ratingsCount: $ratingsCount, reviewsTextCount: $reviewsTextCount, added: $added, addedByStatus: $addedByStatus, metacritic: $metacritic, suggestionsCount: $suggestionsCount, updated: $updated, id: $id, score: $score, clip: $clip, tags: $tags, esrbRating: $esrbRating, userGame: $userGame, reviewsCount: $reviewsCount, saturatedColor: $saturatedColor, dominantColor: $dominantColor, shortScreenshots: $shortScreenshots, parentPlatforms: $parentPlatforms, genres: $genres)';
  }
...
abstract class $EsrbRatingCopyWith<$Res> {
  factory $EsrbRatingCopyWith(
      ...
      _$EsrbRatingCopyWithImpl<$Res>;
  $Res call(
      {int? id, String? name, String? slug, String? nameEn, String? nameRu});
}

/// @nodoc
class _$EsrbRatingCopyWithImpl<$Res> implements $EsrbRatingCopyWith<$Res> {
  _$EsrbRatingCopyWithImpl(this._value, this._then);

  final EsrbRating _value;
  // ignore: unused_field
...
class _$_EsrbRating implements _EsrbRating {
  ...
  factory _$_EsrbRating.fromJson(Map<String, dynamic> json) =>
      _$$_EsrbRatingFromJson(json);
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(nameRu));
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$_EsrbRatingToJson(this);
  }
}
...
abstract class $PlatformCopyWith<$Res> {
  ...
  $GenreCopyWith<$Res>? get platform;
}
...
class _$PlatformCopyWithImpl<$Res> implements $PlatformCopyWith<$Res> {
  ...
  $GenreCopyWith<$Res>? get platform {
    ...
    return $GenreCopyWith<$Res>(_value.platform!, (value) {
...
abstract class $ShortScreenshotCopyWith<$Res> {
  factory $ShortScreenshotCopyWith(
      ...
      _$ShortScreenshotCopyWithImpl<$Res>;
...
class _$_ShortScreenshot implements _ShortScreenshot {
  ...
  factory _$_ShortScreenshot.fromJson(Map<String, dynamic> json) =>
      _$$_ShortScreenshotFromJson(json);
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$_ShortScreenshotToJson(this);
  }
}
